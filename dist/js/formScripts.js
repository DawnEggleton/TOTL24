...
setHogwartsYear(hogwartsYear.value, group);
    ...
    .then((data) => {
        ...
        if(idExists) {
            ...
            let character = {
                ...
                BasicSchool: document.querySelector('#sort-basicschool').value.toLowerCase().trim(),
        ...
        sendDiscordMessage(`971539504487886890/pYMNdC8LukqCbDcOUEyUWHjc_Fsu1gTBt7v7dHEXZxglb3ZA8PVahnZcXvet0S2CPGcL`, settings.message, settings.embedTitle, null, settings.color);
...
document.querySelector('#newedit').addEventListener('submit', e => {
    ...
    .then((data) => {
        ...
        if(idExists) {
            ...
            //if basic school year change
            if(document.querySelector('#choice-basicyear').checked) {
                let characterYear = document.querySelector('#update-hwyear');
                character.HogwartsYear = characterYear.options[characterYear.selectedIndex].innerText.toLowerCase().trim();
                message.push('basic school year');
            }
            ...
            let newCharacter = {
                ...
                Dorm: character.Dorm,
                BasicSchool: character.BasicSchool,
                Message: message,
            }
            return newCharacter;
        } else {
        ...
        //send discord message
        sendDiscordMessage(`967898902684643398/mdDTpl1PiX7EJtEIrGQj0iGPHHf-C0wD-Te0nPz4_-gVafrVCfXUUWLwmnT1gw2-c8El`, settings.message, settings.embedTitle, null, settings.color);
